...
with DAG(
    ...
    pp_cvm_fca_aberta_geral = pre_processing_cvm(dataType='fca_cia_aberta_geral', execution_date=EXECUTION_DATE)
...
environment >> ext_cvm_fca >> upload_s3_r >> unzip_cvm >> pp_cvm_fca_aberta_geral >> upload_s3_p