...
schema_financial_information = StructType([
    StructField('id_cvm', StringType(), True),
    StructField('id_cnpj', StringType(), True),
    StructField('txt_company_name', StringType(), True),
    StructField('dt_fim_exerc', IntegerType(), True),
    ...
    StructField('amt_provisions', FloatType(), True),
    StructField('amt_long_term_liabilities', FloatType(), True),
    StructField('amt_net_cash_operating_activities', FloatType(), True),
    StructField('amt_depreciation_amortization', FloatType(), True),
    StructField('amt_net_cash_investment_activities', FloatType(), True),
    StructField('amt_net_cash_financing_activities', FloatType(), True),
    StructField('amt_exchange_variation_without_cash_equivalents', FloatType(), True),
    StructField('amt_increase_in_cash_equivalents', FloatType(), True),
    StructField('amt_final_balance_cash_equivalents', FloatType(), True),
])
...
varlist_financial_information_analytical = ['id_cvm', 'id_cnpj', 'id_ticker', 'txt_company_name', 'cat_type_dre', 'dt_year', 'dt_quarter', 'dt_fim_exerc',
    ...
    'amt_net_cash_operating_activities', 'amt_depreciation_amortization', 'amt_net_cash_investment_activities',
    'amt_net_cash_financing_activities', 'amt_exchange_variation_without_cash_equivalents', 'amt_increase_in_cash_equivalents',
    'amt_final_balance_cash_equivalents']
